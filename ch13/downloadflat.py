...
remotesite = '192.168.137.118'               # download from this site
remotedir = './DCIM/Screenshots'                          # and this dir (e.g., public_html)
remoteuser = ''
...
print('connecting...')
connection = ftplib.FTP()                 # connect to FTP site
connection.connect(remotesite, 2121)
...
for remotename in remotefiles:
    if remotename in ('.', '..'):
        continue          # some servers include . and ..
    # e.g., ('text/plain', 'gzip')
    ...
    if maintype == 'text' and encoding == None:
        ...
        def callback(line): return localfile.write(line + '\n')
